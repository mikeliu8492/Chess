...
public class Session 
{
	...
	public void undoPlay()
	{
		if (numberTurns > 2)
		{
			int boardIndex = numberTurns - 3;
			chessBoard = historyOfGame.get(boardIndex);
			System.out.println("this is the board you get finally");
	...
	/**
	 * function to set the chessboard from the intermediate board and update both players on the 
	 * piece roster
	 */
	...
	/**
	 * Conditions on which the game can continue
	 * -neither player is in checkmate
	 * -neither player surrenders
	 * -both player haven't agreed to end it
